...
export function HowItWorks(){
    return <section className="py-24 bg-gradient-to-b from-purple-700-10 to-purple-900"
    id="how-it-works">
    ...
    {howItWorksData.map((step,index)=>(
        <div key={index} className="relative group">
            <div className="bg-purple-950 border rounded-2xl p-8 h-full hover:shadow-lg transition-all duration-400 hover:-translate-y-2">
                <div className="flex items-center justify-center w-16 h-16 gradiant-to-br from-primary/10 to-primary-glow/10 rounded-2xl mb-6 group-hover:scale-110 transition-transform">
                <step.icon className="w-8 h-8 text-primary"/></div>
